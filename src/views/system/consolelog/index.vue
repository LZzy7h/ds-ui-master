<template>
  <div class="app-container">
    ...
    <div class="main_content">
      <el-table v-loading="loading" :data="list" class="left-align-table" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="IP"      prop="operIp" width="130" :show-overflow-tooltip="true" />
    ...
    <!-- 操作日志详细 -->
    <el-dialog title="操作日志详细" :visible.sync="open" class="dialog-big" append-to-body>
...
<script>
import { dataAppList, delDataApplog, cleanDataApplog } from "@/api/system/operlog";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      dataAppList(this.addDateRange(this.queryParams, this.dateRange)).then( response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('console/log/export', {
        ...this.queryParams
      }, `consolelog_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
